...
def query_test(triples_list, id_list, true_labels, data_source, input, init_time):
    inferred = []
    true_count = 0
    false_count = 0
    true_pos = 0
...
if __name__ == "__main__":
    ...
    with open('dataset/' + args.test_predicate + '/input/' + args.input) as f:
        ...
        # print triples_list
        # sys.exit()
        query_test(triples_list, id_list, true_labels, args.test_predicate, args.input, init_time)